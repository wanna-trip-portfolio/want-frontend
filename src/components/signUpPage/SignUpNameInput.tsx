...
export const SignUpNameInput: React.FC<{ signUpFormProps: SignUpFormProps }> = React.memo(
  ...
  (prevProps, nextProps) => {
    return prevProps.signUpFormProps.signUpInfo.name === nextProps.signUpFormProps.signUpInfo.name;
  }
);
